...
export function createReadingExperienceModule(deps: ReadingExperienceModuleDependencies): ReadingExperienceModule {
  ...
  const state = Object.freeze({ read: deps.statePort.read.bind(deps.statePort), consumeTicket: deps.statePort.consumeTicket.bind(deps.statePort), consumePermit: deps.statePort.consumePermit.bind(deps.statePort), consumeRepair: deps.statePort.consumeRepair.bind(deps.statePort) });
