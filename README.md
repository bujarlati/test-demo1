...
- 每本小说独立的持久对话线程，以及绑定章节、Revision、选中文本和事件的结构化介入提案
- 死亡否决、关系节奏、责任边界与局部选文重写的影响分析和最小修史闭环
- 不可变 Revision、事实差异、并发版本校验，以及只允许安全回滚最新正史事务的回滚链
...
- 生成观察台：候选/过滤摘要、提示词版本、连接、延迟、成本、持久化作业与安全审计；服务重启后可识别中断作业并安全重试
